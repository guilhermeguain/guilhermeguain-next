...
export const Semrush = () => {
  return (
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="0 0 195.1 26"
      xmlSpace="preserve"
    >
      <path
        d="M134.7,10.2c0-3.2-2-5.5-5.7-5.5h-12.2v16.6h4v-5.7h4.7l4.6,5.7h4.5v-0.4l-4.5-5.4C133,14.9,134.7,12.8,134.7,10.2z
	 M128.5,12.2h-7.7V8.1h7.7c1.4,0,2.3,0.8,2.3,2.1C130.9,11.5,130,12.2,128.5,12.2z"
      ...
      <path
        d="M62.6,11.4c-1.4-0.1-4-0.4-5.5-0.5c-1.4-0.1-2.2-0.6-2.2-1.5c0-0.9,0.9-1.6,4.3-1.6c3,0,5.8,0.7,8.3,1.8V5.9
	...
	c0,1.1-1.3,1.8-4.4,1.8c-3.2,0-6.5-1.1-8.9-2.5v3.8c1.9,1.3,5.1,2.3,8.8,2.3c5.1,0,8.4-2,8.4-5.5C68.4,13.5,66.7,11.8,62.6,11.4z"
      ...
      <path
        d="M169,11.4c-1.4-0.1-4-0.4-5.5-0.5c-1.4-0.1-2.2-0.6-2.2-1.5c0-0.9,0.9-1.6,4.3-1.6c3,0,5.8,0.6,8.3,1.8V5.9
	c-2.4-1.2-5.1-1.7-8.5-1.7c-4.7,0-8,2-8,5.3c0,2.8,1.9,4.4,5.8,4.8c1.4,0.2,3.8,0.4,5.4,0.5c1.8,0.1,2.3,0.7,2.3,1.5
