...
export const Illustrator = () => {
  return (
    ...
    >
      ...
      <path
        fill="#FF9A00"
        d="M116.3,140.4H79.1l-7.6,23.5c-0.2,0.9-1,1.5-1.9,1.4H50.8c-1.1,0-1.4-0.6-1.1-1.8l32.2-92.7
      ...
      <path
        fill="#FF9A00"
        d="M169.8,77c-3.3,0.1-6.5-1.2-8.9-3.5c-2.3-2.5-3.5-5.8-3.4-9.2c-0.1-3.4,1.2-6.6,3.6-8.9
